...
export function ChangeMobile({navigation}){
...
function updateMobile(){
    ...
    form.append("newValue",newMobile);
    ...
    request.onreadystatechange = function () {
      if (request.readyState == 4 && request.status == 200) {
       ...
       Alert.alert("Message","Mobile number updated successfully");
       
      }
    };
    request.open('POST', 'http://192.168.1.189/anychat/updateMobile.php', true);
    request.send(form); 
  }
      ...
      <View style={styles.view2}>
        <View style={styles.view3}>
          <View style={styles.view6}>            
            <Text style={styles.text1}>Edit new mobile number</Text>
          </View>
          <View style={styles.view7}> 
            <TextInput style={styles.input1} defaultValue={mobile} onChangeText={setNewMobile}/>           
          </View>
          <View style={styles.view8}>
            <TouchableOpacity style={styles.button1} activeOpacity={0.6} onPress={updateMobile}>
